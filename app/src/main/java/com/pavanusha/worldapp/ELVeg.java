...
public class ELVeg extends Activity implements OnClickListener
{
    TextView txtContent;
    //define all widgets
...
/*    private String[] soundfile={"0.mp3","1.mp3","2.mp3","3.mp3","4.mp3",
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        imagenumber.setImageResource(R.drawable.batchali);
        txtContent.setText("MalabarSpinanch");
    ...
    private void changeNumber(int screen)
    {
        switch (screen)
        {
            case 0:
                imagenumber.setImageResource(R.drawable.batchali);
                txtContent.setText("MalabarSpinach  ");
                break;
            case 1:
                imagenumber.setImageResource(R.drawable.gongura);
                txtContent.setText("Sorrel Leaves");
                break;
            case 2:
                imagenumber.setImageResource(R.drawable.karivepaku);
                txtContent.setText("Curry Leaves");
                break;
            case 3:
                imagenumber.setImageResource(R.drawable.kotimera);
                txtContent.setText("CorianderLeaves");
                break;
            case 4:
                imagenumber.setImageResource(R.drawable.menthi);
                txtContent.setText("Fenu Greek");
                break;
            case 5:
                imagenumber.setImageResource(R.drawable.palakura);
                txtContent.setText("Spinach");
                break;
            case 6:
                imagenumber.setImageResource(R.drawable.pudina);
                txtContent.setText("Mint  Leavas");
                break;
            case 7:
                imagenumber.setImageResource(R.drawable.totakura);
                txtContent.setText("Amaranath");
                break;
