...
public class GLVeg extends Activity implements OnClickListener
{
    TextView txtContent;
    //define all widgets
    ...
    private void changeNumber(int screen)
    {
        switch (screen)
        {
            ...
            case 6:
                ...
                txtContent.setText("મિન્ટ");
                break;
            case 7:
                imagenumber.setImageResource(R.drawable.totakura);
                txtContent.setText("કરી બગીચામાં");
                break;
