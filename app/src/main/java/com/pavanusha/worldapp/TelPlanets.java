...
public class TelPlanets extends Activity implements OnClickListener
{
	TextView txtContent;
    //define all widgets
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        imagenumber.setImageResource(R.drawable.earth);
        txtContent.setText("భూమి");
    ...
    private void changeNumber(int screen)
    {
        switch (screen)
        {
            case 0:  
                ...
                break;
            case 1:
            	imagenumber.setImageResource(R.drawable.juipter);
            	txtContent.setText(" బృహస్పతి (గురుడు)");
                break;
            case 2:  
            	imagenumber.setImageResource(R.drawable.mars);
            	txtContent.setText("  కుజుడు (అంగారకుడు)");
                break;
            case 3:  
            	imagenumber.setImageResource(R.drawable.mercury);
            	txtContent.setText("బుధుడు  ");
                break;
            case 4:  
            	imagenumber.setImageResource(R.drawable.neptune);
            	txtContent.setText(" వరుణుడు ");
                break;
            case 5:
            	imagenumber.setImageResource(R.drawable.saturn);
            	txtContent.setText(" శని  ");
            	break;
            case 6: 
            	imagenumber.setImageResource(R.drawable.sun);
            	txtContent.setText("సూర్యుడు  ");
            	break;
            case 7:
            	imagenumber.setImageResource(R.drawable.uranus);
            	txtContent.setText(" ఇంద్రుడు");
                break;
            case 8:
            	imagenumber.setImageResource(R.drawable.venus);
            	txtContent.setText(" శుక్రుడు ");
                break;
