...
public class BAnimals extends Activity implements OnClickListener
{
    float size;
    TextView txtContent;
    ImageButton b1,b2;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        try
        {
            input = assetManager.open("benanimals.txt");
    ...
    {
        Intent i = new Intent(BAnimals.this, Bengali.class);
        startActivity(i);
        super.onBackPressed();
    }
