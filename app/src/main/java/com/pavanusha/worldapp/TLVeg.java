...
public class TLVeg extends Activity implements OnClickListener
{
	TextView txtContent;
    //define all widgets
...
/*    private String[] soundfile={"0.mp3","1.mp3","2.mp3","3.mp3","4.mp3",
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        txtContent.setText("மலபார் கீரை  ");
